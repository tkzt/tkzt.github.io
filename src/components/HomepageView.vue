      ...
      <div class="ma-auto tracking-.37">
        ...
        <div class="text-sm md:text-4">
          于 2019 年毕业于<a href="https://www.bing.com/search?q=%E8%A0%A1%E4%B8%93" target="_blank"
            ...
            class="link">这个工地<i
              class="outlink"></i></a>搬砖；生性胆小，爱好和平，不善表达，嗜睡，同时喜爱武侠与科幻；先后在南京、上海、无锡、上海痛恨、改造、亲手堆砌过若干座屎山，艰难积攒财富的同时，轻易地得到了肥胖、肩颈疾病、高血压；是一个<a
            ...
            class="link">玩具</router-link>；云顶之弈好玩赌狗阵容、饥荒里常选<span
            class="line-through">伍迪</span>薇格弗德；由淮扬菜组成，更喜欢苏帮菜，最爱鸡蛋灌饼、煎饼馃子类食物；偶尔心血来潮，写一些<router-link
            to="/boring-blogs"
